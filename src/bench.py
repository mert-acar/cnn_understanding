...
if __name__ == "__main__":
  ...
  for i in range(0, 9, 2):
    ...
    data = loadmat(
      os.path.join(exp_dir, "activations", f"patches_epoch_{epoch}.mat"), variable_names=vars
    )
    for var in vars:
      print(var)
      x = data[var]
      ...
      params = {"n_clusters": [None], "distance_threshold": [k for k in np.linspace(0.1, 20, 20)]}
