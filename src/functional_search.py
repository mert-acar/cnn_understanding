...
if __name__ == "__main__":
  ...
  # exp_path = "../logs/efficientnetb3_IMAGENET/"
  ...
  exp_paths = [
    # "../logs/resnet18_IMAGENET/",
    # "../logs/densenet121_IMAGENET/",
    # "../logs/efficientnetb3_IMAGENET/",
    # "../logs/efficientnetb2_IMAGENET/",
    # "../logs/resnet18_MNIST/",
    "../logs/densenet121_MNIST/",
    # "../logs/efficientnetb3_MNIST/",
    # "../logs/efficientnetb2_MNIST/",
  ]
  for exp_path in tqdm(exp_paths):
